              ...
              <div id="chat-tab" aria-labelledby="base-tab2" class="tab-pane">
                <div id="chatapp" class="col-12">
                  ...
                  <div class="collection border-none">
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-12.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-6.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-11.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-18.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-1.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-2.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-3.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-15.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-19.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-14.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-13.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-22.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-9.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
                    ...
                    <div class="media mb-1"><a><img alt="96x96" src="{{asset('public/app-assets-v/img/portrait/small/avatar-s-20.png')}}" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                      <div class="media-body">
                        <div class="clearfix">
    ...
    <a id="customizer-toggle-icon" class="customizer-toggle bg-danger">
      ...
      <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row sb-bg-img">
          <div class="col-sm-2 mb-3"><img src="{{asset('public/app-assets-v/img/sidebar-bg/01.jpg')}}" width="90" class="rounded sb-bg-01"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('public/app-assets-v/img/sidebar-bg/02.jpg')}}" width="90" class="rounded sb-bg-02"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('public/app-assets-v/img/sidebar-bg/03.jpg')}}" width="90" class="rounded sb-bg-03"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('public/app-assets-v/img/sidebar-bg/04.jpg')}}" width="90" class="rounded sb-bg-04"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('public/app-assets-v/img/sidebar-bg/05.jpg')}}" width="90" class="rounded sb-bg-05"></div>
          <div class="col-sm-2 mb-3"><img src="{{asset('public/app-assets-v/img/sidebar-bg/06.jpg')}}" width="90" class="rounded sb-bg-06"></div>
        </div>
        ...
        <div class="tl-bg-img d-none">
          ...
          <div class="cz-tl-bg-image row">
            <div class="col-sm-3"><img src="{{asset('public/app-assets-v/img/gallery/bg-glass-1.jpg')}}" width="90" class="rounded bg-glass-1 selected"></div>
            <div class="col-sm-3"><img src="{{asset('public/app-assets-v/img/gallery/bg-glass-2.jpg')}}" width="90" class="rounded bg-glass-2"></div>
            <div class="col-sm-3"><img src="{{asset('public/app-assets-v/img/gallery/bg-glass-3.jpg')}}" width="90" class="rounded bg-glass-3"></div>
            <div class="col-sm-3"><img src="{{asset('public/app-assets-v/img/gallery/bg-glass-4.jpg')}}" width="90" class="rounded bg-glass-4"></div>
          </div>
        </div>
        <!-- Transparent BG Image Ends    -->
        <hr>
